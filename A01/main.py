...
#o parametro sys.argv serve pra passar qual parametro quero que seja executado quando executo pela linha de comando 'python main.py link1 link2' -> o [0] pegaria apenas o main.py, e o [1] pega o link1, assim por diante
url = sys.argv[1]
...
# %%
#cria uma 'coleção' e conta quantas vezes ela apareceu
...
# %%
resultado = resultado.sort_values(by='p_freq', ascending= False)
resultado

# %%

print('''
O numero mais frequente é: {}
O numero menos frequente é: {}
A combinação de pares, impares e primos mais frequente é: {} com a frequencia de {}%
'''.format(freq_nr[-1][0], freq_nr[0][0], resultado['Combinacao'].values[0], round(resultado['p_freq'].values[0]*100,2))
